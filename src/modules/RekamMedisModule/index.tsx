...
export const RekamMedisModule = () => {
    ...
    const filteredRekamMedis = rekamMedisList.filter((record) => 
      ...
      record.username_dokter.toLowerCase().includes(searchQuery.toLowerCase()) ||
    ...
    const currentItems = filteredRekamMedis.slice(indexOfFirstItem, indexOfLastItem);
    ...
    const handleAddRekamMedis = (values: RekamMedisFormValues) => {
      const newId = rekamMedisList.length > 0 ? Math.max(...rekamMedisList.map(r => r.id)) + 1 : 1;
    ...
    const handleDeleteRekamMedis = () => {
      ...
      setRekamMedisList(rekamMedisList.filter(record => record.id !== currentRecord.id));
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                ...
                <DialogContent className="sm:max-w-[550px]">
                  ...
                  <Form {...addForm}>
                    <form onSubmit={addForm.handleSubmit(handleAddRekamMedis)} className="space-y-4">
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="sm:max-w-[550px]">
                                <DialogHeader>
                                  ...
                                  <DialogDescription>
                                    Rekam medis untuk {record.nama_hewan} ({record.id_hewan})
                                  </DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4">
                                  <div className="grid grid-cols-2 gap-4">
                                    <div>
                                      <Label className="text-muted-foreground">ID Hewan</Label>
                                      <p className="font-medium">{record.id_hewan}</p>
                                    </div>
                                    <div>
                                      <Label className="text-muted-foreground">Nama Hewan</Label>
                                      <p className="font-medium">{record.nama_hewan}</p>
                                    </div>
                                  </div>
                                  <div className="grid grid-cols-2 gap-4">
                                    <div>
                                      <Label className="text-muted-foreground">Dokter</Label>
                                      <p className="font-medium">{record.username_dokter}</p>
                                    </div>
                                    <div>
                                      <Label className="text-muted-foreground">Tanggal Pemeriksaan</Label>
                                      <p className="font-medium">{record.tanggal_pemeriksaan}</p>
                                    </div>
                                  </div>
                                  <div>
                                    <Label className="text-muted-foreground">Status Kesehatan</Label>
                                    <p>
                                      <Badge className={getStatusColor(record.status_kesehatan)}>
                                        {record.status_kesehatan}
                                      </Badge>
                                  ...
                                  <div>
                                    <Label className="text-muted-foreground">Pengobatan</Label>
                                    <p className="font-medium">{record.pengobatan}</p>
                                  </div>
                                  {record.catatan_tindak_lanjut && (
                                    <div>
                                      <Label className="text-muted-foreground">Catatan Tindak Lanjut</Label>
                                      <p className="font-medium">{record.catatan_tindak_lanjut}</p>
                                    </div>
                                  )}
                                </div>
                              </DialogContent>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="flex items-center space-x-2 bg-red-50 p-3 rounded-md">
              ...
              <p className="text-sm text-red-600">
                Rekam medis untuk {currentRecord?.nama_hewan || ""} pada tanggal {currentRecord?.tanggal_pemeriksaan || ""} akan dihapus.
              </p>
            </div>
