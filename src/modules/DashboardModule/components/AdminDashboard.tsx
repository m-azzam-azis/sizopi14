      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card className="border bg-white">
          ...
          <CardContent>
            ...
            <div
              className={`text-sm ${
                dashboardData.ticketSalesPercentage >= 0
                  ? "text-green-600"
                  : "text-red-600"
              }`}
            >
              {formatPercentage(dashboardData.ticketSalesPercentage)} from
              yesterday
            </div>
        ...
        <Card className="border bg-white">
          ...
          <CardContent>
            ...
            <div
              className={`text-sm ${
                dashboardData.visitorsPercentage >= 0
                  ? "text-green-600"
                  : "text-red-600"
              }`}
            >
              {formatPercentage(dashboardData.visitorsPercentage)} from last
              week
            </div>
            <div className="text-xs text-gray-500 mt-2">
        ...
        <Card className="border bg-white">
          ...
          <CardContent>
            ...
            <div
              className={`text-sm ${
                dashboardData.weeklyRevenuePercentage >= 0
                  ? "text-green-600"
                  : "text-red-600"
              }`}
            >
              {formatPercentage(dashboardData.weeklyRevenuePercentage)} from
              last week
            </div>
            <div className="text-xs text-gray-500 mt-2">
